...
export type FeedLedgerState = {
  entries: Array<LedgerEntry>;
  source: Scalars["String"]["output"];
  watermark: Scalars["Int"]["output"];
};
...
export type LedgerEntryStatus = "RECORDED" | "SUPERSEDED";

export type MarkSupersededInput = {
  externalId: Scalars["String"]["input"];
  payload: Scalars["String"]["input"];
  sequence: Scalars["Int"]["input"];
  supersededId: Scalars["String"]["input"];
